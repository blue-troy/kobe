...
from kobe import kobe_pb2_grpc, kobe_pb2
...
class CallbackModule(CallbackBase):
    ...
    def v2_playbook_on_stats(self, stats):
        ...
        with open("/etc/kobe/app.yml") as file:
            ...
            stub = kobe_pb2_grpc.KobeApiStub(channel)
            task_id = os.getenv("KO_TASK_ID")
            stub.SetAnsibleResult(kobe_pb2.SetAnsibleResultRequest(
                taskId=task_id,
                result=json.dumps(output, cls=AnsibleJSONEncoder, indent=4, sort_keys=True)))
